...
This repository includes a hackathon submission with Phase 1 (Implementation) and Phase 2 (System Design & Architecture). See [HACKATHON.md](./HACKATHON.md) for details.
